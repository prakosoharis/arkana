...
**Updated:** 2026-08-24 — ARK-S14-03 fractional risk and compounding
**Active milestone:** Sprint 14 — Broker-Realistic Historical Capital Simulation
**Active card:** ARK-S14-03 — complete, awaiting Owner acceptance
...
| Capital Simulation | FIXED-LOT AND FRACTIONAL-RISK ENGINES IMPLEMENTED; constraints incomplete | Immutable `CAPITAL_BROKER_CONTRACT_V1` records exact StrategyVersion, MT5 broker snapshot/parity, capital, sizing, leverage, margin, and failure assumptions. Fixed-lot and fractional-risk protocols reuse the sole canonical kernel, verify full-history invariants, convert after-cost price PnL through frozen MT5 tick values, and persist paginable realized-equity paths. Fractional sizing supports explicit compounding and floor-to-broker-grid rounding, then stops at an explicit sizing boundary. Margin, unable-to-trade continuation, liquidation, and intratrade mark-to-market remain unimplemented. |
...
Simulation**. ARK-S14-01 and ARK-S14-02 are accepted; S14-02 was pushed at
commit `4873d7a`. The current card is **ARK-S14-03**: fractional risk,
compounding, and deterministic volume rounding, implemented and awaiting Owner
acceptance. Its runtime evidence and limits are recorded in
`docs/SPRINT_14_CAPITAL_SIMULATION.md`. ARK-S14-04 has not started.
