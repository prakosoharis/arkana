...
export function StrategyLibrary() {
  ...
  async function materializeGenericDecision(version: Strategy) {
    setBusy(true); setMessage(""); try {
      ...
      setOos(null); setGenericChain({ strategyVersionId: version.id, oos: split, stability, decision }); setMessage(`Combined decision: ${decision.decision}. Status tetap NOT VALIDATED sampai workflow promosi terpisah tersedia.`);
